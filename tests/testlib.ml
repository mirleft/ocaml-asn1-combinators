...
let cases = [
  ...
  case "integer" Asn.integer [
    Z.of_int (   0), [0x02; 0x01; 0x00] ;
    Z.of_int ( 127), [0x02; 0x01; 0x7F] ;
    Z.of_int ( 128), [0x02; 0x02; 0x00; 0x80] ;
    Z.of_int ( 256), [0x02; 0x02; 0x01; 0x00] ;
    Z.of_int (-128), [0x02; 0x01; 0x80] ;
    Z.of_int (-129), [0x02; 0x02; 0xFF; 0x7F]
  ];
